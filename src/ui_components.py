...
class UIComponents:
    ...
    def create_stats_tab(self):
        ...
        def stat_card(icon, label, value, key=None):
            ...
            icon_label.setStyleSheet("font-size: 22px; color: #222;")
            card_layout.addWidget(icon_label)
            label_widget = QLabel(label)
            label_widget.setAlignment(Qt.AlignCenter)
            label_widget.setStyleSheet("font-weight: bold; color: #222;")
            card_layout.addWidget(label_widget)
            value_widget = QLabel(value)
            value_widget.setAlignment(Qt.AlignCenter)
            value_widget.setStyleSheet("font-size: 18px; color: #222;")
        ...
        recent_title.setStyleSheet("font-weight: bold; font-size: 15px; color: #222;")
        recent_layout.addWidget(recent_title)
        last_activity = stats.get('last_activity', str(translations.tr("stats.never")))
        last_activity_label = QLabel(last_activity)
        last_activity_label.setStyleSheet("font-size: 14px; color: #222;")
        ...
        avg_label.setStyleSheet("font-size: 15px; color: #222;")
        ...
        streak_label.setStyleSheet("font-size: 15px; color: #222;")
    ...
    def create_success_tab(self, parent_launcher=None):
        ...
        for i, (sid, name, desc) in enumerate(all_successes):
            ...
            name_label.setStyleSheet("color: #222; font-weight: bold;")
            desc_label = QLabel(desc)
            desc_label.setProperty("class", "success-desc")
            desc_label.setStyleSheet("color: #222;")
